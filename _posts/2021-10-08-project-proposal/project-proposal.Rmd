...
* Cross-Validation score
    ...
    Cross Validation Score is used to identify a window size to get different subsets of the data to be parsed into the model.

* Akaike Information Criteria (AIC) score

    AIC evaluates the model generated from the data and sees how well the model can fit other data. It also determines the best evaluated model        that best fits data.
